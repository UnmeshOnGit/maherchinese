...
export const DELIVERY_ZONES = [
  { name: 'Goregaon City', fee: 40 },
  { name: 'Chinchwali', fee: 40 },
  { name: 'Lonere', fee: 60 },
  { name: 'chinchwali wadi', fee: 40 },
  { name: 'Purar', fee: 60 },
  { name: 'Dahiwali', fee: 60 },
];

export const CATEGORIES: Category[] = [
  { id: 'all', name: 'All', name_mr: 'सर्व', icon: '✨' },
  { id: 'starters', name: 'Starters', name_mr: 'स्टार्टर्स', icon: '🍗' },
  { id: 'soup', name: 'Soups', name_mr: 'सूप', icon: '🥣' },
  { id: 'rice', name: 'Rice', name_mr: 'भात', icon: '🍚' },
  { id: 'noodles', name: 'Noodles', name_mr: 'नुडल्स', icon: '🍝' },
  { id: 'chopsy', name: 'Chopsy', name_mr: 'चॉप्सी', icon: '🍜' },
  { id: 'chef-special', name: 'Specials', name_mr: 'स्पेशल', icon: '👨‍🍳' },
  { id: 'soft-drinks', name: 'Drinks', name_mr: 'पेये', icon: '🥤' },
  { id: 'extras', name: 'Extras', icon: '🥚' },
  { id: 'ice-cream', name: 'Ice-cream', name_mr: 'आईस्क्रीम', icon: '🍦' },
];
...
export const DHRUVTAARA_MENU: Dish[] = [
    {
      "id": 1,
      "name": "Munchurian Dry",
      "name_mr": "मंचुरियन ड्राय",
      "description": "Oil fried crispy cabbage munchurian",
      "description_mr": "तेलात तळलेले कुरकुरीत कोबी मंचुरियन",
      "category": "starters",
      "veg": true,
    ...
    },
    {
      ...
      "name_mr": "मंचुरियन ग्रेव्ही",
      "description": "oil fried crispy cabbage munchurian with tasty gravy",
      "description_mr": "चवदार ग्रेव्हीसह तेलात तळलेले कुरकुरीत कोबी मंचुरियन",
      "category": "starters",
      "veg": true,
    ...
    },
    {
      ...
      "description_mr": "दक्षिणेकडील चवीसह मसालेदार खोलवर तळलेले पनीरचे तुकडे",
      "category": "starters",
      "veg": true,
    ...
    },
    {
      "id": 4,
      "name": "Veg Crispy",
      "name_mr": "व्हेज क्रिस्पी",
      "description": "Crispy fried vegetables tossed in tangy seasoning",
      "description_mr": "तळलेल्या कुरकुरीत भाज्या चवदार मसाल्यात मिसळलेल्या",
      "category": "starters",
      "veg": true,
    ...
    },
    {
      "id": 5,
      "name": "Paneer Crispy",
      "name_mr": "पनीर क्रिस्पी",
      "description": "Crispy cottage cheese coated with spices and fried",
      "description_mr": "मसाल्यात घोळवलेले आणि तळलेले कुरकुरीत पनीर",
      "category": "starters",
      "veg": true,
    ...
    },
    {
      ...
      "description_mr": "कुरकुरीत नुडल्स, इंडो-चायनीज सॉस आणि ताज्या भाज्यांचे मिश्रण.",
      "category": "starters",
      "veg": true,
    ...
    },
    {
      ...
      "name_mr": "व्हेज मंचाऊ सूप",
      "description": "Hot & spicy soup topped with crispy noodles",
      "description_mr": "गरम आणि मसालेदार सूप, वरून कुरकुरीत नुडल्स",
      "category": "soup",
      "veg": true,
    ...
    },
    {
      ...
      "description_mr": "भाज्यांनी युक्त घट्ट इंडो-चायनीज सूप",
      "category": "soup",
      "veg": true,
    ...
    },
    {
      ...
      "description_mr": "हॉटेलचे खास पौष्टिक भाज्यांचे सूप",
      "category": "soup",
      "veg": true,
    ...
    },
    {
      ...
      "description_mr": "मिश्र भाज्यांसह अस्सल इंडो-चायनीज फ्राइड राइस",
      "category": "rice",
      "veg": true,
    ...
    },
    {
      ...
      "description_mr": "भाज्यांसह अस्सल इंडो-चायनीज हक्का नुडल्स",
      "category": "noodles",
      "veg": true,
    ...
    },
    {
      ...
      "description_mr": "थंडगार कोला पेय",
    ...
    },
    {
      ...
      "description_mr": "आंबा फळांचे पेय",
      "category": "soft-drinks",
      "veg": true,
    ...
    },
    {
      ...
      "description_mr": "ताज्या अंड्याचे ऑम्लेट",
      "category": "extras",
      "veg": false,
    ...
    },
    {
      ...
      "description_mr": "दक्षिण भारतीय शैलीतील मसाल्यात तळलेले मसालेदार चिकन",
      "category": "starters",
      "veg": false,
    ...
    },
    {
      ...
      "description_mr": "चिकन आणि भाज्यांसह अस्सल फ्राइड राइस",
      "category": "rice",
      "veg": false,
    ...
    },
    {
      ...
      "description_mr": "चिकनसह अस्सल हक्का नुडल्स",
      "category": "noodles",
      "veg": false,
...
export const REVIEWS: Review[] = [
  {
    ...
    comment_mr: 'हॉटेल ध्रुवतारा येथे उत्कृष्ट अनुभव आला. त्यांचे चायनीज पदार्थ खरोखरच प्रभावी आहेत - चवीने भरपूर, उत्तम शिजवलेले आणि ताजे. दुपारचे आणि रात्रीचे जेवण दोन्ही गुणवत्ता आणि सुसंगततेच्या बाबतीत उठून दिसतात.',
    date: '2026-03-22'
  },
  {
    id: 'r2',
    ...
    comment_mr: 'कमी किमतीत दर्जेदार जेवण',
    date: '2026-03-08'
  },
  {
    id: 'r3',
