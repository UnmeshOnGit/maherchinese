        ...
        {activeTab === 'home' && (
           <div className="space-y-8 sm:space-y-12 pb-12 animate-in fade-in duration-500">
             <div className="relative h-[400px] sm:h-[480px] rounded-[32px] sm:rounded-[40px] overflow-hidden mt-4 shadow-xl">
               <img src="https://drive.google.com/uc?export=view&id=1uUFwCGWHGj7W12QE3JQ4USyQjnpIyC96" className="w-full h-full object-cover" alt="Hotel Dhruvtaara Hero" referrerPolicy="no-referrer" />
